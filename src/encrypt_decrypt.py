...
encrypt_text("data/raw_text.txt", "data/encrypted_text.txt", 2, 3)
decrypt_text("data/encrypted_text.txt", "data/decrypted_text.txt", 2, 3)
if check_correctness("data/raw_text.txt", "data/decrypted_text.txt"):
